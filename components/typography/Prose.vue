...
<template>
	<div
		...
		:class="[
			...
			'prose max-w-none prose-p:mt-8 prose-img:rounded-lg prose-img:border-2 prose-img:border-gray-500 prose-headings:font-display prose-headings:font-semibold prose-headings:mt-4',
